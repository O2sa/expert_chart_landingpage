    ...
    <footer className="text-black dark:text-white bg-white dark:bg-black text-center md:text-start ">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 flex flex-col md:mb-0 justify-center items-center md:items-start">
            <a href="/" className="flex justify-center">
              <img
                src="/images/small_logo.png"
                className="h-8 me-3"
                alt="ChartExpert logo"
              />
            ...
            <div className="mt-6">
              <h6>{t("Accepted Payment Methods")}</h6>
          ...
          <div className="flex gap-6 flex-wrap justify-center">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a
                    href="mailto:support@chartxpert.io"
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            Copyright {new Date().getFullYear()} ChartExpert {t("All Rights Reserved.")}
          </span>
